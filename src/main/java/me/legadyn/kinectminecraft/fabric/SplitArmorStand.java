...
public class SplitArmorStand {
    ...
    private static ArmorStandEntity generateArmorStand(BlockPos pos, ServerWorld world, ServerPlayerEntity player) {
        ...
        player.getServer().getCommandManager().execute(player.getCommandSource().withSilent(), "/data merge entity " + armorStand1.getUuidAsString() + " {NoBasePlate:1b,ShowArms:1b}");
        return armorStand1;
    }
